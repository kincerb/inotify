...
def get_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Server to publish inotify events", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    parser.add_argument(
        "paths", nargs="*", default=["/usr/bin/python3", "/home/kincerb"], help="Filesystem paths to monitor."
    )
    parser.add_argument(
        "-s",
        "--socket",
